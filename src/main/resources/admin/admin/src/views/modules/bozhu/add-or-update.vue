...
export default {
            ...
            ruleForm: {
                	        bozhuzhanghao: '',
	                        	        ...
	                        	        youxiang: '',
                                                              ...
                                                              rules: {
                  bozhuzhanghao: [
                            { required: true, message: '博主账号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
                            { required: true, message: '密码不能为空', trigger: 'blur' },
                                    	                                                              ],
                  bozhuxingming: [
                            { required: true, message: '博主姓名不能为空', trigger: 'blur' },
                                    	                                                              ],
                  touxiang: [
                                    	                                                              ],
                  xingbie: [
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `bozhu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.bozhuCrossAddOrUpdateFlag = false;
                  this.parent.search();
